var newsInfo = [{
...

  {
    ...
    'content': "<p>What happens when you put thousands of Teaching and Learning Innovation Leaders and Higher Ed IT Professionals in the same place for one week?  This October, Steve Bailey (Director, Academic + Campus Events) and I went to the Mile High City to attend the highly anticipated Educause 2018 Conference.</p>" +
      ...
      "<img src='images/news_images/181130E.jpg'/>" +
      ...
      "<img src='images/news_images/181130F.jpg'/>" +
      ...
      "<img src='images/news_images/181130G.jpg' />"
  },
  {
  ...
  },
  {
    ...
    'content': "<p>Students returning to school may see wider seats, more writing space – and get this – electrical outlets within reach to charge laptops and phones.</p>" +
  ...
  },
  {
      ...
      'summary': "Steven Bailey and Emily Ling of Academic + Campus Events believe the Lee & Margaret Lau Auditorium, located in the new Myhal Centre for "
      + "Engineering Innovation & Entrepreneurship, is a model for the future of teaching and learning at the university.",
  ...
  {
      'title': 'Project Primer: Transforming the Instructional Landscape',
      'author': 'By Nick Smith',
      'date': 'July 8, 2019',
      'image': '080719A.jpg',
      'link': 'http://blogs.studentlife.utoronto.ca/innovationhub/category/hub-blog/',
      'summary': "In the Transforming the Instructional Landscape (TIL) project, we try to understand what makes a classroom work as a"
      + " productive learning environment. As this work has progressed, it has expanded to include many perspectives: we started by focusing on the "
      + "student experience, but came to realize that student experiences are entangled with the experiences of other people who spend time in and "
      + "around classrooms, and with the spaces and things that promote learning.",

      'content': "<p>In the Transforming the Instructional Landscape (TIL) project, we try to understand what makes a classroom work as a"
      + " productive learning environment. As this work has progressed, it has expanded to include many perspectives: we started by focusing on the "
      + "student experience, but came to realize that student experiences are entangled with the experiences of other people who spend time in and "
      + "around classrooms, and with the spaces and things that promote learning.</p>"

      + "<p>To capture this bigger picture of how classrooms work, the Innovation Hub broadened its inquiry last year, conducting interviews with course "
      + "instructors, shadowing audio-visual technicians, and hosting six public feedback events. Out of this work, “connectivity” emerged as a lens "
      + "through which to understand the classroom experience. We modelled this idea in our"
      + "<a href='https://ace.utoronto.ca/til/documents/TILReport.PDF' target='_blank'> latest report </a>"
      + "with a diagram that shows the dynamic relationship between interpersonal, virtual, and physical connections, all of which are influenced by—and contribute to—the accessibility "
      + "and emotional experience of a classroom. The diagram depicts the interdependence of these different types of connection: without comfortable "
      + "and flexible furniture, for example, it becomes harder to build interpersonal connections between students, instructors, and TAs.</p>"

      + "<img src='images/news_images/080719B.jpg'/>"

      + "<p> Others have also taken up this theme of connectivity in the classroom. At the Teaching and Learning Symposium in May, core members of the "
      + "TIL project presented a poster to faculty, librarians, students, and staff who brought out the theme of connectivity in their own talks. At the "
      + "session on podcast pedagogy, for example, they discussed podcasting as a practice of imaginative listening and narrative connection, and in "
      + "the lightning talks, Glenn Brauen discussed pedagogical approaches that connect spaces with our experiences of them.</p>"

      + "<img src='images/news_images/080719C.jpg'/>"

      + "<p> To help create classrooms that promote connectivity, the Innovation Hub produced design principles for learning spaces. Design principles "
      + "provide guidelines to reflect upon when designing objects, spaces, and processes, so that the final design better reflects the needs of users, "
      + "as determined through interviews and user feedback.</p>"

      + "<img src='images/news_images/080719D.jpg'/>"

      + "<p> As we plan our fall work, we hope to expand upon the themes of connectivity and community, and work towards the vision expressed in our "
      + "design principles. We are conducting a group brainstorm on ways we can bring students and teachers to discuss with each other what does and "
      + "doesn’t work in the classroom. Students learn from instructors about diverse topics here at U of T. But how might students and teachers learn "
      + "from each other about the classroom experience itself? </p>"

      + "<p> We also plan to integrate our work with the work of those who are improving pedagogy. As seen from the design principle of “Instructors as "
      + "Partners,” we discovered that the physical design of classrooms and the organizational design of managing those rooms are intertwined with "
      + "pedagogy. How a classroom should look and function depends on how instructors teach. Thus, we’re excited to collaborate with the Centre for "
      + "Teaching Support and Innovation, and with the TIL Advisory Committee of senior academic leaders and instructors, which was convened by "
      + "Vice-Provost Susan McCahan. </p>"

      + "<p>These are the visions and collaborations that are driving our work this summer. Stay tuned for updates.</p>"

      + "<p>This post is part of the Project Primer series, in which we introduce the projects the Innovation Hub is conducting this summer. To learn "
      + "about our other work, check out "
      + "<a href='http://blogs.studentlife.utoronto.ca/innovationhub/project-primer-accessibility-at-convocation/' target='_blank'>"
      + "our last </a> <a href='http://blogs.studentlife.utoronto.ca/innovationhub/project-primer-family-care/' target='_blank'>"
      + "two </a> posts, and come back next week for more!</p> "
    },
   {
      'title': 'Transforming Educational Spaces at UofT',
      'author': 'By Darren Clift',
      'date': 'November 14, 2019 ',
     
      'link': 'https://blogs.studentlife.utoronto.ca/innovationhub/transforming-educational-spaces-at-uoft/#more-3379',
      'summary': "Each cohort of students arrives at UofT with unique considerations and learning style preferences. Today’s students are digital natives; technology is a fundamental tool for socialization and self-improvement in their lives.",
      'content': "<img src='images/news_images/191114A.jpg' />"
	  + "<p>Each cohort of students arrives at UofT with unique considerations and learning style preferences. Today's students are digital natives; technology is a fundamental tool for socialization and self-improvement in their lives. Since students’ needs have changed, classrooms and teaching methods must adapt. A standard room with standard desks might not favour learning, while a standard lecture style might distract rather than inspire.</p>"
	  + "<p>At a historic and complex institution like UofT, redesigning learning can be a challenge <a href='https://www.ace.utoronto.ca/til/'>The Transforming the Instructional Landscape (TIL)</a> project offers a potential solution by interrogating and integrating the perspectives of all stakeholders—students, instructors, and staff—to transform educational spaces and practices for modern students’ needs. By working with Academic + Campus Events and the Centre for Teaching Support and Innovation, the Innovation Hub is building a process for classroom redesign that integrates learning, pedagogy, and technology. Redesign is more than a fresh coat of paint; it’s a culture built from spaces and those who use them.</p>"
	  + "<p>This is the third year of the Innovation Hub’s involvement with TIL. Its TIL Design Team, led this year by Master of Information student Jason Batten-Carew, is reviewing the efforts of the past two years and building a human-centred design process for classrooms, with a focus on stakeholder engagement, to be used in future redesigns. The team will interview various groups and stakeholders affected by TIL’s rollout so far, asking questions such as “How did you get involved with TIL?“ and “Would you change anything about the classroom design process?“ Designing learning spaces for students with varied educational expectations, and teaching spaces for instructors with different styles, is a challenge. Consistently ensuring that all stakeholder voices are heard, and all needs uncovered, requires a dedicated approach, which the team will create this year.</p>"
	  ...
	  + "<p>Many factors are involved in education transformation: learning styles, teaching styles, cultural and technological changes. None of these exists in a vacuum, and by better understanding how physical space intersects with all of them, TIL can help transform education at UofT.</p>"
